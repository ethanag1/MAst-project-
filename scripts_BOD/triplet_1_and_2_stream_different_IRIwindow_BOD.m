...
title(['Baseline and different IRI Median Windowed Plot of Channel ', num2str(columnIndex)]); 
...
% Save the figure
saveas(gcf, '/home/ethan/fig_BOD(p2)/baseline_corrected_and_IRIMedian_separate_windowed_separated_triplets_for_single_channel29_BOD(p2).png');
...
% Add super title
sgtitle('1 stream and 2 stream Baseline and different IRI Median Windowed Triplets for All Channels');

% Save the figure
saveas(gcf, '/home/ethan/fig_BOD(p2)/baseline_corrected_and_IRIMedian_separated_windowed_separated_triplets_for_all_channels_BOD(p2).png');

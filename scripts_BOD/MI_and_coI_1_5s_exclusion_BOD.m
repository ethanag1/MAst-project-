...
% Save figure
%saveas(gcf, '/home/ethan/fig_BOD(p2)/mi_channel1_significantlog_1_5s_exclusion_BOD(p2).png');
...
hold off;
%saveas(gcf, '/home/ethan/fig_BOD(p2)/mi_channel1_significantnormal_1_5s_exclusion_BOD(p2).png');
disp(max(time_ms));

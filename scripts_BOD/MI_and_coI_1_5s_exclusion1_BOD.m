...
saveas(gcf, '/home/ethan/fig_BOD(p2)/mi_all_channels_significant_1_5s_exclusion_BOD(p2).png');
...
% Save the figure
saveas(gcf, '/home/ethan/fig_BOD(p2)/within_channel_signifcoi_significant_channels_1.5s_exclusion_BOD(p2).png');
...
% Save the figure
saveas(gcf, '/home/ethan/fig_BOD(p2)/within_channel_syn_signifcoi_significant_channels_1.5s_exclusion_BOD(p2).png');
disp('✅ Saved COI plot for all significant channels.');
...
% Save the figure
saveas(gcf, '/home/ethan/fig_BOD(p2)/within_channel_red_signifcoi_significant_channels_1_5s_exclusion_BOD(p2).png');
disp('✅ Saved COI plot for all significant channels.');
...
% Save the figure
saveas(gcf, '/home/ethan/fig_BOD(p2)/within_channel_coi_significant_channels_1_5s_exclusion_BOD(p2).png');
disp('✅ Saved COI plot for all significant channels.');

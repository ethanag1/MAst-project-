...
% Save the figure
saveas(gcf, '/home/ethan/fig_BOD(p2)/baseline_corrected_separated_triplets_for_channel29_BOD(p2).png');
...
% Add super title
sgtitle('1 stream and 2 stream Baseline Corrected Triplets for All Channels');

% Save the figure
saveas(gcf, '/home/ethan/fig_BOD(p2)/baseline_corrected_separated_triplets_for_all_channels_BOD(p2).png');

...
saveas(gcf, '/home/ethan/fig_BOD(p2)/mi_all_channels_significant_IRIcorrected_BOD(p2).png');
...
% Save figure
saveas(gcf, '/home/ethan/fig_BOD(p2)/mi_channel1_significantlog_IRIcorrected_BOD(p2).png');
...
hold off;
saveas(gcf, '/home/ethan/fig_BOD(p2)/mi_channel1_significantnormal_IRIcorrected_BOD(p2).png');
disp(max(time_ms));

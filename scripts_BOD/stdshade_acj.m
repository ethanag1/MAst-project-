function stdshade_acj(amatrix,alpha,acolor,F,smth)
...
amean=smooth(mean(amatrix,'omitnan'),smth)';
%astd=nanstd(amatrix); % to get std shading
astd=std(amatrix,'omitnan')/sqrt(size(amatrix,1)); % to get sem shading

...
% Save the figure
saveas(gcf, '/home/ethan/fig_BOD(p2)/baseline_corrected_and_IRIMedian_combined_windowed_separated_triplets_for_channel29_BOD(p2).png');
...
% Save the figure
saveas(gcf, '/home/ethan/fig_BOD(p2)/baseline_corrected_and_IRIMedian_combined_windowed_separated_triplets_for_all_channels_BOD(p2).png');

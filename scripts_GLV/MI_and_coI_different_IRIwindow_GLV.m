...
saveas(gcf, '/home/ethan/fig_GLV(p3)/mi_all_channels_significant_different_IRIwindow_GLV(p3).png');
...
% Save figure
saveas(gcf, '/home/ethan/fig_GLV(p3)/mi_channel1_significantlog_different_IRIwindow_GLV(p3).png');
...
hold off;
saveas(gcf, '/home/ethan/fig_GLV(p3)/mi_channel1_significantnormal_different_IRIwindow_GLV(p3).png');
disp(max(time_ms));

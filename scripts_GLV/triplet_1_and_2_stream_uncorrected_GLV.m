...
% Save the figure
saveas(gcf, '/home/ethan/fig_GLV(p3)/baseline_corrected_separated_triplets_for_channel2_GLV(p3).png');
...
% Save the figure
saveas(gcf, '/home/ethan/fig_GLV(p3)/baseline_corrected_separated_triplets_for_all_channels_GLV(p3).png');

...
% Save the figure
saveas(gcf, '/home/ethan/fig_GLV(p3)/baseline_corrected_and_IRIMedian_separate_windowed_separated_triplets_for_single_channel2_GLV(p3).png');
...
% Save the figure
saveas(gcf, '/home/ethan/fig_GLV(p3)/baseline_corrected_and_IRIMedian_separated_windowed_separated_triplets_for_all_channels_GLV(p3).png');

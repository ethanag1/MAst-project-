...
% Save the figure
saveas(gcf, '/home/ethan/fig_GLV(p3)/baseline_corrected_separated_triplets_1_5s_exclusion_for_channel2_GLV(p3).png');
...
% Save the figure
saveas(gcf, '/home/ethan/fig_GLV(p3)/baseline_corrected_separated_triplets_1.5s_exclusion_for_all_channels_GLV(p3).png');

...
% Save figure
saveas(gcf, '/home/ethan/fig_GLV(p3)/mi_channel1_significantlog_1_5s_exclusion_GLV(p3).png');
...
hold off;
saveas(gcf, '/home/ethan/fig_GLV(p3)/mi_channel1_significantnormal_1_5s_exclusion_GLV(p3).png');
disp(max(time_ms));

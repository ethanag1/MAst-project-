...
% Save the figure
saveas(gcf, '/home/ethan/fig_GLV(p3)/baseline_corrected_test_for_single_channel_GLV(p3).png');
...
saveas(gcf, '/home/ethan/fig_GLV(p3)/baseline_corrected_test_for_all_channels_GLV(p3).png');

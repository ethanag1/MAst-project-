...
% Save the figure
saveas(gcf, '/home/ethan/fig_GLV(p3)/within_channel_signifcoi_significant_channels_same_IRIwindow_GLV(p3).png');
...
% Save the figure
saveas(gcf, '/home/ethan/fig_GLV(p3)/within_channel_syn_signifcoi_significant_channels_same_IRIwindow_GLV(p3).png');
disp('✅ Saved COI plot for all significant channels.');
...
% Save the figure
saveas(gcf, '/home/ethan/fig_GLV(p3)/within_channel_red_signifcoi_significant_channels_same_IRIwindow_GLV(p3).png');
disp('✅ Saved COI plot for all significant channels.');
...
% Save the figure
saveas(gcf, '/home/ethan/fig_GLV(p3)/within_channel_coi_significant_channels_same_IRIwindow_GLV(p3).png');
disp('✅ Saved COI plot for all significant channels.');

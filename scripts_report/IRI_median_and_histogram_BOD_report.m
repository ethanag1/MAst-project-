...
% Save the figure
saveas(gcf, '/home/ethan/fig_BOD(p2)/IRI_histograms_1_and_2_seperate_BOD(p2).png');
...
xlabel('Inter-response interval (Sec)', 'FontSize', 14);
ylabel('Occurrences', 'FontSize', 14);

% Add text with statistics in the top-right
xLimits = xlim;
yLimits = ylim;
text(xLimits(2) - 1.5, yLimits(2) -0.1, ...
...
% Save the figure
saveas(gcf, '/home/ethan/fig_report/IRI_histogram_1_and_2_Combined_BOD(p2).png');

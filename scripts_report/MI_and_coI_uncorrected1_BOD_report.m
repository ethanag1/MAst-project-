...
selectedIndices_stimTwo = startIndices_stimTwo(1:3:end-2); 
...
for i = 1:numSections
    ...
    if startIdx >= 1 && endIdx <= numTimePoints
        BaselineMatrix_3D(:, :, i) = dp_data(startIdx:endIdx, :); 
    else
...
% Save the figure
saveas(gcf, '/home/ethan/fig_report/MI_and_coI_uncorrected_plotted_together_BOD(p2).png');

...
ax2.YTick = mi_yticks;
ax2.YTick = mi_yticks;
ax2.YTickLabel = {'0', '0.016'};  % Force display in decimal format
...
saveas(fig, '/home/ethan/fig_report/ERP_separated_triplets_with_MI_plot_uncorrected_for_channel25_TYH.png');

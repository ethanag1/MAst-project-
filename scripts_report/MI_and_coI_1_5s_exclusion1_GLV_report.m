...
selectedIndices = combinedIndices_excluded;
...
% edit these to change:
    ...
    n_pl = 1000; % number of permutations
...
n_pl3 = 1000; % number of permutations for COI
...
% Save the figure
saveas(gcf, '/home/ethan/fig_report/MI_and_coI_1_5s_exclusion_plotted_together_GLV(p3)1000perms.png');
...
Percentage_triplets_identified = length(combinedIndices) / 750 * 100;

...
yLimits = [-25, 25]; % Set symmetric limits
...
ylabel('Voltage (μV)'); % Y-axis label
...
% Save the figure
saveas(gcf, '/home/ethan/fig_report/ERP_excluded_vs_included_channel13_BOD(p2).png');
...
% Save the figure
saveas(gcf, '/home/ethan/fig_report/ERP_excluded_vs_included_channel14_BOD(p2).png');
...
% Save the figure
saveas(gcf, '/home/ethan/fig_report/ERP_excluded_vs_included_channel126_BOD(p2).png');

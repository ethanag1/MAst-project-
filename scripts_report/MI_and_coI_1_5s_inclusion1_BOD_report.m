...
selectedIndices = combinedIndices_included;
...
l_(ismember(selectedIndices, selectedIndices_stimOne)) = 0;
l_(ismember(selectedIndices, selectedIndices_stimTwo)) = 1;
...
% Save the figure
saveas(gcf, '/home/ethan/fig_report/MI_and_coI_included_triplets_BOD(p2).png');
